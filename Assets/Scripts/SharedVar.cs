...
public class SharedVar : NetworkBehaviour
{
    ...
    public void character_sprite()
    {
        ...
        {
            sprite1.transform.localPosition = new Vector3(3.6f, -1.8f, -.4f);
        ...
        {
            sprite1.transform.localPosition = new Vector3(2.8f, -1.4f, -.4f);
        ...
        if (player2char == 1)
        {
            sprite2.transform.localPosition = new Vector3(2.75f, -2.3f, -.3f);
